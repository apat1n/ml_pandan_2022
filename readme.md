...
## Пререквизиты:
- Базовое понимание математики ([Можно освежить алгебру здесь](https://algorithmica.org/ru/linalg), теорию вероятности [отюсда](https://stepik.org/lesson/10107/step/1?unit=1951) и [отсюда](https://towardsdatascience.com/a-probability-crash-course-for-data-science-cd4b4fae03bc))
- *Храбрость и отвага*
